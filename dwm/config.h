...
static char normbordercolor[]       = "#d65d0e";
...
/* systray */
static const unsigned int systraypinning = 0;   /* 0: siga o monitor com foco, >0: pin no monitor X */
static const unsigned int systrayonleft = 0;    /* 0: systray no canto direito, 1: esquerdo */
static const unsigned int systrayspacing = 2;   /* espaçamento entre ícones */
static const int systraypinningfailfirst = 1;   /* 1: se pinning falhar, exibe no primeiro monitor, 0: exibe no último */
