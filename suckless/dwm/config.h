...
static const char col_bg_dark[]   = "#21252b";
static const char col_gray_dark[] = "#3a3f4b";
static const char col_fg[]        = "#abb2bf";
static const char col_fg_sel[]    = "#e6e6e6";
static const char col_blue[]      = "#61afef";

static const char *colors[][3] = {
	/*               fg           bg            border     */
	[SchemeNorm] = { col_fg,      col_bg_dark,  col_bg_dark },
	[SchemeSel]  = { col_fg_sel,  col_gray_dark, col_blue   },
};
