...
alpine)
	...
	APP_PKGS=(vim bash pavucontrol xclip nodejs feh firefox-esr unzip i3 i3blocks i3-gaps)
...
fedora)
	...
	APP_PKGS=(vim-X11 cava bash pavucontrol xclip nodejs feh firefox unzip i3 i3blocks i3-gaps)
...
arch)
	...
	APP_PKGS=(gvim cava bash pavucontrol xclip nodejs feh firefox unzip i3 i3blocks i3-gaps)
	SYS_PKGS=(dbus networkmanager polkit)
	INIT_SYS="systemd"
	;;
debian | ubuntu)
	...
	APP_PKGS=(vim-gtk3 cava bash pavucontrol alsa-utils xclip nodejs feh firefox-esr unzip wpa_supplicant i3 i3blocks)
