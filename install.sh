...
alpine)
	...
	APP_PKGS=(vim bash pavucontrol xclip nodejs feh firefox-esr unzip i3 i3blocks)
...
fedora)
	...
	APP_PKGS=(vim-X11 cava bash pavucontrol xclip nodejs feh firefox unzip i3 i3blocks)
...
arch)
	...
	APP_PKGS=(gvim cava bash pavucontrol xclip nodejs feh firefox unzip i3 i3blocks)
	SYS_PKGS=(dbus networkmanager polkit)
	INIT_SYS="systemd"
	;;
debian | ubuntu)
